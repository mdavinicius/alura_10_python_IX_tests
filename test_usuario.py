from python_9_testes_automatizados_tdd.dominio import Usuario, Leilao
import pytest
...
def test_deve_permitir_propor_lance_quando_o_valor_e_menor_que_o_valor_da_caretira(vini, leilao):
...
def test_nao_deve_permitir_propor_lance_quando_o_valor_e_maior_que_o_valor_da_carteira(vini, leilao):
